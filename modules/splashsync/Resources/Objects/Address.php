...
/**
 * @abstract    Splash Local Object Class - Customer Addresses Local Integration 
...
//            $Data[$key]["fullname"] = Splash::Tools()->encodeFullName($Customer["firstname"],$Customer["lastname"],$Customer["company"]);
        ...
        Splash::Log()->Deb("MsgLocalTpl",SPL_O_CUSTOMERS,__FUNCTION__,(count($Data)-1)." Customers Found.");
        return $Data;
    }
